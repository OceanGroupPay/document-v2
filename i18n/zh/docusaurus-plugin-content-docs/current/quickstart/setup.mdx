...
### 步骤 1. 登录商家门户
访问【<EnvVariable envKey={"ENV_BRAND"} />商户门户】<EnvVariable domainPrefix={`https://merchant.`} envKey={"ENV_DOMAIN"} /> ,然后在 **侧边栏** 左起，进入 **开发管理** -> **开发设置**
...
:::note
请妥善保管**私钥**，因为 <EnvVariable envKey={"ENV_BRAND"} /> 不会存储私钥。
:::
