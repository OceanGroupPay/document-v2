...
| 参数 | 类型 | 必填 | 说明 | 示例 |
| :------------- | :----: | :------: | :----------------------------------------------------------------------------------------------------- | :------------------------------: |
| `CLIENT_ID`     | String |   是    | Client ID/ AppID 可以从[商户平台](https://merchant.mypay88.asia)获取。         |       10020                     |
| `CLIENT_SECRET` | String |   是    | Client secret/ AppSecret 可以从 [商户平台](https://merchant.mypay88.asia)获取。 | F0NfID1ftdGdu27ybGMfT3vqqCMM9gwO |
...
**接口:** https://api.mypay88.asia/gggpay/v1/createToken
