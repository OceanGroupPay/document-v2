...
:::info
{"customer":{"name":"Long Wan","phone":"0123456789","email":"longwan@gmail.com"},"method":"CIMB_MY","order":{"id":"A20221111","title":"Payment","amount":"88.50","currencyType":"MYR","additionalData":""}}
:::
...
<b>接口:</b> <EnvVariable domainPrefix={`https://api.`} envKey={"ENV_DOMAIN"} domainPostfix={`/gggpay/v1/createPayment`}  />
