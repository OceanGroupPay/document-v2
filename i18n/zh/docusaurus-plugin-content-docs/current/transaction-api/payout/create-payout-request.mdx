...
| 参数   |  类型  | 必填 | 说明               |     示例      |
| :---------- | :----: | :------: | :------------------------ | :--------------: |
| `order`     | Object |   是    | 订单信息，对象字段为 <br />[id, amount, currencyType]  |  |
| `recipient`  | Object |   是    | 收款人信息, 对象字段为 <br />[name, phone, email, methodType, methodValue, methodRef] |  |
...
| `email`       | String | 是 | 客户邮箱                         | ""         |
| `phone` | String | 是 | 客户电话                 | ""         |
| `methodType` | String | 是 | 列表 [提款/出款 - Swift Code](/docs/appendix/payment-method#提款出款---swift-code)                 | "RHBBMYKL"         |
...
### 第 4 步：POST 到 `/gggpay/v1/withdrawRequest` 接口

**方式 :** <span style={{ color: "orange", fontWeight: "bold" }}>POST</span><br/>
**接口:** https://api.mypay88.asia/gggpay/v1/withdrawRequest
