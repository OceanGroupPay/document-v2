---
title: Create Payout/ Withdraw Request
---
...
| Parameter   |  Type  | Required | Description               |     Example      |
| :---------- | :----: | :------: | :------------------------ | :--------------: |
| `order`     | Object |   Yes    | order information, with keys of <br />[id, amount, currencyType]  |  |
| `recipient`  | Object |   Yes    | Recipient information, with keys of <br />[name, phone, email, methodType, methodValue, methodRef] |  |
...
| `methodType` | String | Yes | Type of Method, please refer to [Withdraw / Payout - Swift Code](/docs/appendix/payment-method#withdraw--payout---swift-code)                 | "RHBBMYKL"         |
...
:::info
{"order":{"id":"10006","amount":"1","currencyType":"MYR"},"recipient":{"name":"Long Wan","phone":"0123456789","email":"helpcare@mypay88.co","methodType":"CIBBMYKL","methodValue":"8044591766","methodRef":""}}
:::
...
### Step 4: POST to `/gggpay/v1/withdrawRequest` endpoint

**Method :** <span style={{ color: "orange", fontWeight: "bold" }}>POST</span><br/>
**Endpoint:** https://api.mypay88.asia/gggpay/v1/withdrawRequest
