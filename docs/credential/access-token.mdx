...
| :------------- | :----: | :------: | :----------------------------------------------------------------------------------------------------- | :------------------------------: |
| `CLIENT_ID`     | String |   Yes    | Client ID or AppID as obtained from [Merchant Portal](https://merchant.mypay88.asia).         |       10020                     |
| `CLIENT_SECRET` | String |   Yes    | Client secret or AppSecret as obtained from [Merchant Portal](https://merchant.mypay88.asia). | F0NfID1ftdGdu27ybGMfT3vqqCMM9gwO |
...
**Endpoint:** https://api.mypay88.asia/gggpay/v1/createToken
